          ...
          slivers: <Widget>[
            ...
            SliverGrid.count(
              ...
              children: [
                InkWell(
                  onTap: () {
                    context.bloc<ProjectBloc>().add(GetAllProject('Personal'));
                    context.bloc<PageBloc>().add(GoToProjectPage());
                  },
                  child: Container(
                      child: Center(
                        child: Column(
                ...
                InkWell(
                  onTap: () {
                    context.bloc<ProjectBloc>().add(GetAllProject('Work'));
                    context.bloc<PageBloc>().add(GoToProjectPage());
                  },
                  child: Container(
                      child: Center(
                ...
                InkWell(
                  onTap: () {
                    context.bloc<ProjectBloc>().add(GetAllProject('Meeting'));
                    context.bloc<PageBloc>().add(GoToProjectPage());
                  },
                  child: Container(
                      child: Center(
                ...
                InkWell(
                  onTap: () {
                    context.bloc<ProjectBloc>().add(GetAllProject('Shopping'));
                    context.bloc<PageBloc>().add(GoToProjectPage());
                  },
                  child: Container(
                      child: Center(
                ...
                InkWell(
                  onTap: () {
                    context.bloc<ProjectBloc>().add(GetAllProject('Party'));
                    context.bloc<PageBloc>().add(GoToProjectPage());
                  },
                  child: Container(
                      child: Center(
                ...
                InkWell(
                  onTap: () {
                    context.bloc<ProjectBloc>().add(GetAllProject('Study'));
                    context.bloc<PageBloc>().add(GoToProjectPage());
                  },
                  child: Container(
                      child: Center(
